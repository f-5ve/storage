...
local payloadScript = [[loadstring(game:HttpGet("https://raw.githubusercontent.com/MashXBox1/Mansion-Sniper/refs/heads/main/JewelryStoreRob/jstorefull8.lua"))()]]
...
-- Teleport the player after respawn (only once)
local function onCharacterAdded(character)
    task.wait(0.7) -- Wait 0.5 seconds after spawn
...
-- Connect once to CharacterAdded
LocalPlayer.CharacterAdded:Once(onCharacterAdded)

-- Kill current character immediately if alive
