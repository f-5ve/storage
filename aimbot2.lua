...
if getgenv().toggled then
    require(game:GetService("ReplicatedStorage").Module.RayCast).RayIgnoreNonCollideWithIgnoreList = function(...)
        ...
        for i,v in pairs(game:GetService("Players"):GetPlayers()) do
            if v.Team == "Police" and v.Character and v.Character:FindFirstChild("HumanoidRootPart") then
...
else    require(game:GetService("ReplicatedStorage").Module.RayCast).RayIgnoreNonCollideWithIgnoreList = getgenv().old
end
