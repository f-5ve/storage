--[[ Configuration ]]--
_G.WRDESPEnabled = true --Enables the ESP.
_G.WRDESPBoxes = true --Draws boxes around other players.
_G.WRDESPTeamColors = true --Distinguish different teams by their team color.
