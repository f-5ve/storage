do --// UI Source
    ...
    Library = {
        ...
        local AutoLoadFile = Library.Directory .. "/AutoLoad.json"
        ...
        local function LoadConfigByName(Name)
            ...
            local ConfigPath = ConfigsFolder .. Name .. ".json"

            if not isfile(ConfigPath) then
                return false, "config not found"
            end

            return Library:LoadConfig(readfile(ConfigPath))
        end
        ...
        local function ReadAutoLoad()
            ...
            if Success and type(Data) == "table" and Data.Enabled and type(Data.Config) == "string" then
        ...
        local function WriteAutoLoad(Enabled, Name)
        ...
        do
            Library.CreateColorpicker = function(Self, Data)
                ...
                function Colorpicker:SetOpen(Bool)
                    ...
                    if Colorpicker.IsOpen then
                        ...
                        local BaseY = RowElement and (RowElement.AbsolutePosition.Y + GuiInset + 20) or (ColorpickerButton.AbsolutePosition.Y + ColorpickerButton.AbsoluteSize.Y + GuiInset)
            ...
            Library.InitWindow = function(Self)
                            ...
                            Callback = function()
                                if ConfigSelected then
                                    ...
                                    if Success then
                                        ...
                                        Library:Notification{Name = "failed to load config: ".. tostring(Error), Time = 3}
                                    end
                                end
                            end
                        })
                ...
                if AutoLoadEnabled and AutoLoadConfig then
                    task.defer(function()
                        AutoLoadReady = false

                        if ConfigsDropdown and ConfigsDropdown.Options[AutoLoadConfig] then
                            ConfigsDropdown:Set(AutoLoadConfig)
                        end

                        local Success, Error = LoadConfigByName(AutoLoadConfig)
