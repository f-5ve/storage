...
ao.User.Anonymous and 1 or game:GetService("Players").LocalPlayer.UserId,
...
ag("TextLabel",{
Text=ao.User.Anonymous and"Anonymous"or game:GetService("Players").LocalPlayer.DisplayName,
TextSize=17,
ThemeTag={
TextColor3="Text",
},
...
ag("TextLabel",{
Text=ao.User.Anonymous and"@anonymous"or"@"..game:GetService("Players").LocalPlayer.Name,
TextSize=15,
TextTransparency=.6,
ThemeTag={
TextColor3="Text",
